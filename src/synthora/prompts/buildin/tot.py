...
Your task is to evaluate the Agent's responses against these guidelines and provide a score. Be objective and strict in your evaluation based on the criteria.
