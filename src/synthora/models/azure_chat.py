...
class AzureChatBackend(BaseModelBackend):
    """Azure OpenAI Chat Completion backend implementation.
    ...
    def default(  # type: ignore[override]
        ...
        **kwargs: Any,
        ...
        r"""Return the default Azure OpenAI Chat model backend."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.kwargs["azure_endpoint"] = self.azure_endpoint
        if self.api_version is None:
            raise ValueError("API Version is required for Azure OpenAI")
        self.kwargs["api_version"] = self.api_version
